...
const CreateScheduleModal = ({ isOpen, onClose }) => {
  ...
  const handleCreateSchedule = (event) => {
    ...
    const formatedDateandHour = convertToTimeStamp(newScheduleDate, newScheduleHour);
  ...
  return (
    ...
    >
      <Form onSubmit={handleCreateSchedule}>
        ...
        <Line color={theme.colors.lightGray2} height="fit-content" width="100%" />
        ...
        <Container
          ...
          gap="20px"
        >
          <Label style={labelStyle} htmlFor="scheduleName" children={"Nome da 1:1"} />
          <Input
            style={inputStyle}
            type="text"
            name="scheduleName"
          ...
          <Container width="100%" display="flex" justifyContent="space-between">
            <Container display="flex" flexDirection="column" justifyContent="stretch" width="45%" flexShrink="0">
              <Label style={labelStyle} htmlFor="scheduleDate" children={"Data da 1:1"} />
              <Input
                style={{
                  ...inputStyle,
                }}
            ...
            <Container display="flex" flexDirection="column" justifyContent="stretch" width="45%" flexShrink="0">
              <Label style={labelStyle} htmlFor="scheduleHour" children={"Horário da 1:1"} />
              <Input
                style={{
                  ...inputStyle,
                  minWidth: "50%",
                ...
                type="time"
                name="scheduleHour"
                onChange={(event) => setNewScheduleHour(event.target.value)}
                value={newScheduleHour}
              />
            </Container>
          </Container>

          <Label style={labelStyle} htmlFor="guest" children={"Convidado"} />
          <Select
            style={inputStyle}
            name="guest"
          ...
          <Span fontSize="18px" fontStyle="normal" fontWeight="500" lineHeight="normal" color={theme.colors.black}>
          ...
          {talkingPoints.map((talkingPoint, index) => (
            <Container
              ...
              key={index}
            >
              <Container minWidth="100%%" paddingBottom="20px" display="flex" alignItems="center" justifyContent="space-between">
                <div style={{ color: "black" }}>ICON</div>

                <Container width="80%">
                  <Label style={labelStyle} htmlFor={`scheduleTopic_${index}`} children={"Nome do talking point"} />
                  ...
                  <Input
                    ...
                    onChange={(event) => updateTalkingPoint(index, event.target.value)}
